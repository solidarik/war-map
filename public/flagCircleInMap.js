...
var flagCircleInMap = function () {
    ...
    _createClass(flagCircleInMap, [{
        ...
        value: function addFlagCircleInMap() {
            ...
            this.svg.selectAll("circle").data(this.data).enter().append("circle").attr("id", "flags")
        ...
        value: function addFlagCircleInMapNew() {
            ...
            .attr('r', function (d) {
                ...
                var htmlData = d.rusCountry + "<br/>" + Math.round(res * 100) / 100 + " " + d.rusUnit + "<a target='_blank' rel='noopener noreferrer' href='" + d.rusSource + "'>*</a>";
