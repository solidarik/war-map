...
function () {
  ...
  addSlider.getListYear = function getListYear(data) {
    var listYear = [];
  ...
  addSlider.getListYearNew = function getListYearNew(data) {
    var listYear = []; // var fdata = data.filter(function (n) {
    // 	return n.iso3 === "RUS";
    // });
  ...
  addSlider.getListYearNewArray = function getListYearNewArray(data) {
    var listYear = [];
    data.forEach(function (d) {
  ...
  addSlider.filterByYear = function filterByYear(data, yearFilter) {
    var dataYearFilter = [];
    data.forEach(function (d) {
      var curElemnt = {};
      curElemnt.id = d.id;
  ...
  addSlider.filterByYearNew = function filterByYearNew(data, yearFilter) {
  ...
  addSlider.addSlider = function addSlider(idElemForSvg, width, listYear, updateFunction) {
    var margin = {
      top: 75,
      right: 50,
      bottom: 0,
