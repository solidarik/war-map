...
loadedData.push({ "id": "3", "EngName": "Loss of dead soldiers in 1 world", "RusName": "Потери погибшими солдатами в 1 мировой", "url": "data/loss_of_dead_soldiers_in_1_world.json", "jsonType": "UFA", "RusGroup": "Вооруженые силы", "EngGroup": "Armed Forces" });
loadedData.push({ "id": "4", "EngName": "The loss of dead soldiers in World 2", "RusName": "Потери погибшими солдатами во 2 мировой", "url": "data/the_loss_of_dead_soldiers_in_world_2.json", "jsonType": "UFA", "RusGroup": "Вооруженые силы", "EngGroup": "Armed Forces" });
loadedData.push({ "id": "5", "EngName": "Heavy artillery", "RusName": "Тяжелая артиллерия", "url": "data/heavy_artillery.json", "jsonType": "UFA", "RusGroup": "Вооруженые силы", "EngGroup": "Armed Forces" });
loadedData.push({ "id": "6", "EngName": "The number of military aircraft", "RusName": "Численность военных самолетов", "url": "data/the_number_of_military_aircraft.json", "jsonType": "UFA", "RusGroup": "Вооруженые силы", "EngGroup": "Armed Forces" });
loadedData.push({ "id": "7", "EngName": "Military strength", "RusName": "Численность ВС", "url": "data/military_strength.json", "jsonType": "UFA", "RusGroup": "Вооруженые силы", "EngGroup": "Armed Forces" });
loadedData.push({ "id": "8", "EngName": "The number of fighters", "RusName": "Численность истребителей", "url": "data/the_number_of_fighters.json", "jsonType": "UFA", "RusGroup": "Вооруженые силы", "EngGroup": "Armed Forces" });
loadedData.push({ "id": "9", "EngName": "The number of ships", "RusName": "Численность кораблей", "url": "data/the_number_of_ships.json", "jsonType": "UFA", "RusGroup": "Вооруженые силы", "EngGroup": "Armed Forces" });
loadedData.push({ "id": "10", "EngName": "The number of large ships", "RusName": "Численность крупных кораблей", "url": "data/the_number_of_large_ships.json", "jsonType": "UFA", "RusGroup": "Вооруженые силы", "EngGroup": "Armed Forces" });
loadedData.push({ "id": "11", "EngName": "The number of submarines", "RusName": "Численность подводных лодок", "url": "data/the_number_of_submarines.json", "jsonType": "UFA", "RusGroup": "Вооруженые силы", "EngGroup": "Armed Forces" });
loadedData.push({ "id": "12", "EngName": "Ground Forces", "RusName": "Численность сухопутных войск", "url": "data/ground_forces.json", "jsonType": "UFA", "RusGroup": "Вооруженые силы", "EngGroup": "Armed Forces" });
loadedData.push({ "id": "13", "EngName": "The number of tanks", "RusName": "Численность танков", "url": "data/the_number_of_tanks.json", "jsonType": "UFA", "RusGroup": "Вооруженые силы", "EngGroup": "Armed Forces" });
loadedData.push({ "id": "14", "EngName": "Gold mining", "RusName": "Добыча золота", "url": "data/gold_mining.json", "jsonType": "UFA", "RusGroup": "Промышленность", "EngGroup": "Industry" });
loadedData.push({ "id": "15", "EngName": "Oil production", "RusName": "Добыча нефти", "url": "data/oil_production.json", "jsonType": "UFA", "RusGroup": "Промышленность", "EngGroup": "Industry" });
loadedData.push({ "id": "16", "EngName": "Gas production", "RusName": "Добыча природного газа", "url": "data/gas_production.json", "jsonType": "UFA", "RusGroup": "Промышленность", "EngGroup": "Industry" });
loadedData.push({ "id": "17", "EngName": "Coal production", "RusName": "Добыча угля", "url": "data/coal_production.json", "jsonType": "UFA", "RusGroup": "Промышленность", "EngGroup": "Industry" });
loadedData.push({ "id": "18", "EngName": "Mineral fertilizers", "RusName": "Минеральные удобрения", "url": "data/mineral_fertilizers.json", "jsonType": "UFA", "RusGroup": "Промышленность", "EngGroup": "Industry" });
loadedData.push({ "id": "19", "EngName": "Aluminum production", "RusName": "Производство аллюминия", "url": "data/aluminum_production.json", "jsonType": "UFA", "RusGroup": "Промышленность", "EngGroup": "Industry" });
loadedData.push({ "id": "20", "EngName": "Steel production", "RusName": "Производство стали", "url": "data/steel_production.json", "jsonType": "UFA", "RusGroup": "Промышленность", "EngGroup": "Industry" });
loadedData.push({ "id": "21", "EngName": "Cement production", "RusName": "Производство цемента", "url": "data/cement_production.json", "jsonType": "UFA", "RusGroup": "Промышленность", "EngGroup": "Industry" });
loadedData.push({ "id": "22", "EngName": "Iron production", "RusName": "Производство чугуна", "url": "data/iron_production.json", "jsonType": "UFA", "RusGroup": "Промышленность", "EngGroup": "Industry" });
loadedData.push({ "id": "23", "EngName": "Power generation", "RusName": "Производство электроэнергии", "url": "data/power_generation.json", "jsonType": "UFA", "RusGroup": "Промышленность", "EngGroup": "Industry" });
loadedData.push({ "id": "24", "EngName": "Total losses in World War 2", "RusName": "Общие потери во 2 мировой войне", "url": "data/total_losses_in_world_war_2.json", "jsonType": "UFA", "RusGroup": "Сельское хозяйство", "EngGroup": "Agriculture" });
...
loadedData.push({ "id": "62", "EngName": "Population (Merged data)", "RusName": "Население", "url": "data/DTO/Population (Merged data).json", "jsonType": "UFA", "RusGroup": "Экономика", "EngGroup": "Economy" });
loadedData.push({ "id": "63", "EngName": "GDP (Merged data)", "RusName": "ВВП", "url": "data/DTO/GDP (Merged data).json", "jsonType": "UFA", "RusGroup": "Экономика", "EngGroup": "Economy" });
loadedData.push({ "id": "64", "EngName": "PerCapita GDP", "RusName": "ВВП на душу", "url": "data/DTO/PerCapita GDP.json", "jsonType": "UFA", "RusGroup": "Экономика", "EngGroup": "Economy" });
loadedData.push({ "id": "65", "EngName": "Industry (including construction), value added (current US$)", "RusName": "Промышленность", "url": "data/DTO/Industry (including construction), value added (current US$).json", "jsonType": "UFA", "RusGroup": "Экономика", "EngGroup": "Economy" });
loadedData.push({ "id": "66", "EngName": "Manufacturing, value added (current US$)", "RusName": "Производство", "url": "data/DTO/Manufacturing, value added (current US$).json", "jsonType": "UFA", "RusGroup": "Экономика", "EngGroup": "Economy" });
loadedData.push({ "id": "67", "EngName": "Agriculture, forestry, and fishing, value added (current US$)", "RusName": "Сельскоехозяйство", "url": "data/DTO/Agriculture, forestry, and fishing, value added (current US$).json", "jsonType": "UFA", "RusGroup": "Экономика", "EngGroup": "Economy" });
loadedData.push({ "id": "68", "EngName": "Cereal production (metric tons)", "RusName": "Производство зерна", "url": "data/DTO/Cereal production (metric tons).json", "jsonType": "UFA", "RusGroup": "Экономика", "EngGroup": "Economy" });
...
function startApp() {
	...
	d3.json(url, function (error, countries) {
		...
		console.log('d3.select("#mapContainer").style("width")='+d3.select("#mapContainer").style("width"));
