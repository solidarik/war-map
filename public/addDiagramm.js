    ...
    fdataGDPTOP10.forEach(function (d) {
        d.forEach(function (d1) {
            ...
            if(typeof fdataIndustry[0] !=='undefined'){
                indObj.industry=Math.trunc((fdataIndustry[0].value || 0)/1000000000);
            }
            else{
                indObj.industry=0;
            }
            ...
            if(typeof fdataServices[0] !=='undefined'){
                indObj.services=Math.trunc((fdataServices[0].value || 0)/1000000000);
            }
            else{
                indObj.services=0;
            }
            ...
            obj.iso2=d1.iso2;
            obj.iso3=d1.iso3;
            obj.gdp=Math.trunc(d1.value/1000000000);
            obj.year=year;
