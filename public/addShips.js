...
var addShips = /*#__PURE__*/function () {
  ...
  _createClass(addShips, null, [{
    ...
    value: function addShip(divId, shipData) {
      ...
      div.appendChild(newNode); // <div class="row img image-cont">
      //     <img class="image-center img-rounded resized-image" id="imgPerson" src="img/ships/Prince_of_Wales.jpg" alt="">
      // </div>
