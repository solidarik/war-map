...
var addAircrafts = /*#__PURE__*/function () {
  function addAircrafts() {
    _classCallCheck(this, addAircrafts);
  }

  _createClass(addAircrafts, null, [{
    key: "addAircraft",
    value: function addAircraft(divId, aircraftData) {
      ...
      newNode.classList.add("row");
      div.appendChild(newNode); // newNode = document.createElement('div');      
